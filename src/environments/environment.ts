...
export const environment = {
  production: false,
  API_URL: 'https://app.econogruas.com/econogruas-backend/api',
  OPERATOR_URL: 'https://app.econogruas.com/econogruas-backend/api/operators',

  //API_URL: 'http://localhost:8020/api',
  //OPERATOR_URL: 'http://localhost:8020/api/operators',
  app_name: 'Grip´s OP',
  firebase: {
